...
3. Run focused tests, the runtime harness or justified `N/A`, and agentic validation when affected.
...
Return the work-unit scope, changed and excluded files, test and runtime evidence, maintenance performed, rollback boundary, and local commit hash. State explicitly that no push or deployment occurred.
