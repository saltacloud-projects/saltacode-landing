...
The proposed human-control, identity-linking, opportunity, and durable-outbound evolution is planned in [`human-led-omnichannel-sales.md`](./human-led-omnichannel-sales.md). That roadmap is not proof that those capabilities are implemented or that any provider route is active.
