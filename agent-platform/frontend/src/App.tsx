...
function ProtectedRoute({ children }: { children: React.ReactNode }) {
  ...
  if (loading) {
    return (
      <div className="grid min-h-screen place-items-center text-sm text-gray-500" role="status">
        Cargando…
      </div>
    );
  }
...
function AgentWorkspaceRoute() {
  ...
  if (error)
    return (
      <div
        className="rounded border border-red-500/30 bg-red-500/10 p-4 text-sm text-red-400"
        role="alert"
      >
        {error}
      </div>
    ...
    return (
      <section className="mx-auto max-w-xl rounded-lg border border-[var(--border-color)] bg-[var(--bg-card)] p-6 text-center">
        ...
        <p className="mt-2 text-sm text-[var(--text-secondary)]">
          El agente de esta URL no existe o no está disponible para tu cuenta.
        </p>
        <a
          href="/agents"
          className="mt-4 inline-flex rounded bg-[var(--accent)] px-4 py-2 text-sm text-white"
        >
          Volver a agentes
        </a>
      </section>
        ...
        <Routes>
          ...
          <Route element={<PanelShell />}>
            ...
            <Route
              path="agents"
              element={
                <PermissionRoute permission={PERMISSIONS.PROFILES_READ}>
                  <ProfilesPage />
                </PermissionRoute>
              }
            />
            <Route
              path="shared/sources"
              element={
                <PermissionRoute permission={PERMISSIONS.SOURCES_READ}>
                  <SourcesPage scope="library" />
                </PermissionRoute>
              }
            />
            <Route
              ...
              element={
                <PermissionRoute permission={PERMISSIONS.KNOWLEDGE_READ}>
                  <KnowledgePage scope="library" />
                </PermissionRoute>
              }
            />
            <Route
              path="shared/tools"
              element={
                <PermissionRoute permission={PERMISSIONS.TOOLS_READ}>
                  <ToolsPage scope="library" />
                </PermissionRoute>
              }
            />
            <Route
              ...
              element={
                <PermissionRoute permission={PERMISSIONS.DOCUMENTS_READ}>
                  <DocumentsPage scope="library" />
                </PermissionRoute>
              }
            />
            <Route
              path="shared/provider-connections"
              element={
                <PermissionRoute permission={PERMISSIONS.CONNECTIONS_READ}>
                  <ProviderConnectionsPage />
                </PermissionRoute>
              }
            />
            <Route
              path="shared/channel-connections"
              element={
                <PermissionRoute permission={PERMISSIONS.CONNECTIONS_READ}>
            ...
            <Route
              ...
              element={
                <PermissionRoute permission={PERMISSIONS.AUDIT_READ}>
                  <LegacyAgentRedirect section="audit" fallback="/agents" />
                </PermissionRoute>
              }
            />
            <Route
              path="panel-users"
              element={
                <PermissionRoute permission={PERMISSIONS.PANEL_USERS_MANAGE}>
                  <PanelUsersPage />
                </PermissionRoute>
              }
            />
            ...
            <Route path="agents/:agentId" element={<AgentWorkspaceRoute />}>
              ...
              <Route
                path="overview"
                element={
                  <PermissionRoute permission={PERMISSIONS.DASHBOARD_READ}>
                    <DashboardPage />
                  </PermissionRoute>
                }
              />
              ...
              <Route
                path="runtime"
                element={
                  <PermissionRoute permission={PERMISSIONS.RUNTIME_READ}>
                    <AgentRuntimePage />
                  </PermissionRoute>
                }
              />
              ...
              <Route
                path="promptlab"
                element={
                  <PermissionRoute permission={PERMISSIONS.PROMPTLAB_USE}>
                    <PromptLabPage />
                  </PermissionRoute>
                }
              />
            ...
            <Route
              path="knowledge"
              element={<LegacyAgentRedirect section="knowledge" fallback="/shared/knowledge" />}
            />
            <Route
              path="tools"
              element={<LegacyAgentRedirect section="tools" fallback="/shared/tools" />}
            />
            <Route
              path="documents"
              element={<LegacyAgentRedirect section="documents" fallback="/shared/documents" />}
            />
            <Route
              path="provider-connections"
              element={<Navigate to="/shared/provider-connections" replace />}
            />
            <Route
              path="channel-connections"
              element={<Navigate to="/shared/channel-connections" replace />}
            />
            <Route
              path="runtime"
              element={<LegacyAgentRedirect section="runtime" fallback="/agents" />}
            />
            <Route
              path="users"
              element={<LegacyAgentRedirect section="access" fallback="/agents" />}
            />
            <Route
              path="conversations"
            ...
            <Route
              path="promptlab"
              element={<LegacyAgentRedirect section="promptlab" fallback="/agents" />}
            />
          </Route>
